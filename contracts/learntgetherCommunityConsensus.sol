...
interface learntgtetherCommuunitiesInterfact{
...
contract learntgetherCommunityConsensus{
    ...
    learntgtetherCommuunitiesInterfact public CommunityContract;
    ...
    constructor(uint256 _feePrice, address _communityContractAddress, uint256 _communityFee, address payable _feeAddress) {
        ...
        CommunityContract= learntgtetherCommuunitiesInterfact(_communityContractAddress);
    ...
    */
    ...
    function checkLog(
        Log calldata log,
        bytes memory
    ) external view returns (bool upkeepNeeded, bytes memory _performData) {
    ...
    */
    ...
    function setlearntgetherCommunityContract(address _contractAddress) external onlyOwner {
        CommunityContract= learntgtetherCommuunitiesInterfact(_contractAddress);
